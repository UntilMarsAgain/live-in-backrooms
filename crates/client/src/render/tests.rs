...
fn asset_manager_sync_gpu_uploads_and_reclaims() {
    ...
    let mut assets = crate::render::AssetManager::new(device, queue, lbr_shared::core::resource::MergedResourceSpace::new(std::env::temp_dir()));
    let mesh = assets.meshes_mut().register(lbr_shared::Mesh::cube());
