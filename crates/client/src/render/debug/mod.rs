...
use lbr_shared::core::aabb::Aabb;
use lbr_shared::core::asset::MeshSource;
use lbr_shared::core::light::LightKind;
use lbr_shared::scene::{Scene, SceneObjectKind};
...
mod tests {
    ...
    fn collision_gizmos_wire_a_single_cube() {
        ...
        let key = assets.meshes_mut().register(lbr_shared::Mesh::cube());
        scene.add_object(SceneObject::new(
